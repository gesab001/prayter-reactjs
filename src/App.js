				   ...
				   <div className="right">       { this.state.signup
					  ...
					  <div className="emailPasswordForm">
					    ...
					    <div className="loginbuttons">
							<div className="socialIcons"  onClick={event => {
						...
						<div>  Log in with Yahoo</div>
						</div>
						
						<div className="loginbuttons">
						<div className="socialIcons" onClick = {(event) => {this.signInWithTwitter()}}>
						...
						{/*<div className="socialIcons" onClick = {(event) => {this.signInWithMicrosoft()}}>
							...
							<form onSubmit={this.signInHandler}>
							 ...
							 <div>Password <span className="forgotPassword" onClick = {(event) => {this.forgotPasswordHandler()}}>Forgot Password</span></div>
					   ...
					   <div><span>Don't have an account?</span><span className="signUpLink" onClick = {(event) => {this.signupHandler()}}> Sign up </span>	</div>							
					 </div>
